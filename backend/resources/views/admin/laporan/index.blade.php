...
<div class="bg-white rounded-lg shadow-sm border border-gray-200">
    <div class="p-4 border-b border-gray-200">
        <!-- Form Filter -->
        <form action="{{ route('admin.laporan.index') }}" method="GET" class="flex flex-col lg:flex-row items-stretch lg:items-end gap-3">
            <div>
            ...
            <div class="flex gap-2">
                ...
                @if(request()->anyFilled(['start_date', 'end_date', 'status']))
                    <a href="{{ route('admin.laporan.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-700 px-4 py-2 text-sm rounded-lg flex items-center transition">
                        Reset
                    </a>
